...
type level struct {
	...
	tileDescriptionProvider *snakeTileDescriptionProvider
}
...
func CreateLevel(c LevelConfig) *level {
	l := level{
		...
		tileDescriptionProvider: newSnakeTileDescriptionProvider(),
	}
...
func (l *level) GetTileDescriptionProvider() interfaces.TileDescriptionProvider {
	return l.tileDescriptionProvider
}
